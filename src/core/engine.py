...
v0.5A:
    - Preserves continuous run support.
    - Adds module diagnostics payloads so collapse controls can report capture,
      respawn, and radius data.
"""
...
class RealMathUniverseEngine:
    ...
    def diagnostics_payload(self) -> dict:
        warmup_avg = (
            ...
            if self.warmup_frame_times_ms else 0.0
        )
        return {
